...
<template>
    ...
    <div class="bg-surface-50 flex items-center justify-center min-h-screen min-w-screen overflow-hidden">
            ...
            <div class="border-2 border-white"
                ...
                <div class="w-full bg-surface-0 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8">
                        ...
                        <div class="text-surface-900 text-3xl font-medium mb-4">Creating an Account</div>
                    </div>
                    ...
                    <div>
                        ...
                        <label for="password" class="block text-surface-900 font-medium text-xl mb-2">Password</label>
                        ...
                        <router-link :to="{ name: 'login' }"
                            class="mt-2 font-medium no-underline ml-2 text-right cursor-pointer text-primary">
