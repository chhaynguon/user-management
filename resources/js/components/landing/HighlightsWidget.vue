<template>
    <div id="highlights" class="py-6 px-6 lg:px-20 mx-0 my-12 lg:mx-20">
        <div class="text-center">
            <div class="text-surface-900 font-normal mb-2 text-4xl">Powerful Everywhere</div>
        ...
        <div class="grid grid-cols-12 gap-4 mt-20 pb-2 md:pb-20">
            ...
            <div class="col-span-12 lg:col-span-6 my-auto flex flex-col lg:items-end text-center lg:text-right gap-4">
                ...
                <div class="leading-none text-surface-900 text-3xl font-normal">Congue Quisque Egestas</div>
                <span class="text-surface-700 text-2xl leading-normal ml-0 md:ml-2" style="max-width: 650px"
        ...
        <div class="grid grid-cols-12 gap-4 my-20 pt-2 md:pt-20">
            <div class="col-span-12 lg:col-span-6 my-auto flex flex-col text-center lg:text-left lg:items-start gap-4">
                ...
                <div class="leading-none text-surface-900 text-3xl font-normal">Celerisque Eu Ultrices</div>
                <span class="text-surface-700 text-2xl leading-normal mr-0 md:mr-2" style="max-width: 650px"
